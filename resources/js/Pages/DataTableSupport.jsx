...
export const DataTableSupport = ({ DataSupport = [], refresh, loading }) => {
  const investments = Array.isArray(DataSupport)
    ? DataSupport.filter((item) => item.type === "Familly Support")
    : [];
    ...
    <div className="container py-4">
      ...
      <div className="card border-0 shadow-lg rounded-3 overflow-hidden">
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #0f172a 0%, #d81d8a 100%)",
          }}
        >
          <div className="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center gap-3">
            <div>
              <h4 className="mb-1 fw-bold">Familly and Friends support History</h4>
              <small className="text-white-50">
                Manage and track all your familly and friends support
              </small>
            </div>
